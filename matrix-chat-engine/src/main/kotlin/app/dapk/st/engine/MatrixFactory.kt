...
import app.dapk.engine.core.SingletonFlows
...
import app.dapk.st.matrix.auth.DeviceDisplayNameGenerator as MatrixDeviceDisplayNameGenerator
...
internal object MatrixFactory {
    ...
    fun createMatrix(
        ...
        it.install {
            installAuthService(credentialsStore, nameGenerator.matrix())
...
private fun DeviceDisplayNameGenerator.matrix(): MatrixDeviceDisplayNameGenerator {
    return MatrixDeviceDisplayNameGenerator { this.generate() }
}
